	...
	const slides: Slide[] = [
		{
			id: 'user-start',
			nav: 'Start',
			title: `Welcome to ${data.businessName}`,
			subtitle: 'Team Flow',
			description: 'Your shift tools are ready.',
			bullets: ['See today plan', 'Check assigned tasks', 'Open references fast'],
			background: {
				kind: 'image',
		...
		},
		{
			id: 'user-flow',
			nav: 'Flow',
			title: 'Work from one clear loop',
			subtitle: 'Schedule -> Tasks -> Execution',
			description: 'Open schedule, complete tasks, and keep service moving.',
			bullets: ['Shift visibility', 'Task ownership', 'Operational clarity'],
			background: {
				kind: 'image',
				src: '/marketing/FB_IMG_3952972665318110830.jpg',
				position: 'center center',
				alt: 'Pass consistency'
			},
			shot: {
		...
		},
		{
			...
			description: 'Finish to open your team dashboard.',
			bullets: ['Quick orientation', 'Priority view', 'Ready for shift'],
			background: {
				kind: 'image',
...
<section class="tour-shell" aria-label="User welcome slideshow">
