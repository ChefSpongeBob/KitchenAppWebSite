...
export const actions: Actions = {
  ...
  update_checklist_category: ({ request, locals }) => updateChecklistCategory(request, locals),
  delete_checklist_category: ({ request, locals }) => deleteChecklistCategory(request, locals),
