...
- Active phase: `14. Authentication, session, abuse, and account lifecycle test`
- Status: Phase 13 camera feature shelving is validated locally; next pass is auth/session/account lifecycle validation.
- Current pass: Phase 14 login, register, invite, onboarding, logout, reset password, continue signed-in, tenant switching, account deletion, and abuse controls.
