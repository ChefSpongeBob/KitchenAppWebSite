...
- Active phase: `21. Google Play Store readiness`
- Status: Phase 21 Google Play repo readiness is validated locally. Remaining Google Play blockers are external/manual: create Play Console app record, complete App Content and Data safety declarations, create Play Billing subscription products, upload an Android App Bundle to internal testing, provide sign-in review details, add screenshots/listing metadata, and run sandbox Play Billing on a real Android device.
- Current pass: Phase 21 Google Play Store readiness. Android package identity, app labels, release manifest safety, Play Billing dependency, Play Billing server verification, billing notifications, public review URLs, subscription purchase/restore/management surfaces, and Google Play readiness guard are validated.
